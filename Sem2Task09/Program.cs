...
if (firstNum > secondNum) 
    Console.WriteLine("Первое число {0} больше второго {1}", firstNum, secondNum);
else
    Console.WriteLine("Второе число {0} больше первого {1}", secondNum, firstNum);

// Вариант 2
char[] digits = numSintezator.Next(10,100).ToString().ToCharArray();
Console.WriteLine(digits);
firstNum = (short)(digits[0]-48);
